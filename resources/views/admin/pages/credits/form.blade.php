...
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">
            ...
            </span>New Customer's Savings
        </h3>
        <nav aria-label="breadcrumb">
            <ul class="breadcrumb">
            <li class="breadcrumb-item active" aria-current="page">
                <span></span>Customers/<a href="{{ route('admin.customer.credits') }}">Credits</a>/Add <i class="mdi mdi-alert-circle-outline icon-sm text-primary align-middle"></i>
            </li>
            </ul>
        </nav>
    </div>
