            ...
            <div class="form-form-background">
                <form class="form-form" action="">
                    ...
                    <div class="form-input-wrapper">
                        ...
                        <input name="purpose" class="form-input" style="color: black;font-size: 14px;" type="tex1t" value="Php {{ $balance }}" readonly>
                    </div>
                    <div class="form-input-wrapper">
                        <label for="purpose" class="form-input-label" style="width: 51vw;text-align: justify;font-size: 14px;">Credit Balance:</label>
                        <input name="purpose" class="form-input" style="color: black;font-size: 14px;" type="tex1t" value="Php {{ $credits }}" readonly>
                    </div>
                    <div class="form-input-wrapper">
